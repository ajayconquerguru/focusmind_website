module.exports = {
  ...
  presskit_download_link: "https://conquerdream.com",                                  // Enter a link to downloadable file or (e.g. public Dropbox link to a .zip file). 
  video_or_screenshot   : "screenshot",                                           // "screenshot" or "video"
  app_url               : "https://agalp.imedadel.me",                            // Domain of your website without path_prefix.
  path_prefix           : "/",                                                    // Prefixes all links. For cases when deployed to example.github.io/automatic-gatsbyjs-app-landing-page/.
  app_name              : "FOCUS MIND",
  app_price             : "Free",
  app_description       : "To spent some time with YOU",
  app_keywords          : ["automatic", "gatsbyjs", "app", "landing page"],

  // Personal Info
  your_name              : "Conquer Guru",
  your_link              : "https://conquerdream.com",
  your_city              : "Sousse",
  email_address          : "",
